---
title: Solver Worker Integration
...
To initiate the proposal request process, the Solver listens for `RequestProposal` events on the designated networks: **Berachain**, **Polygon Amoy**, or **Binance Testnet**. 
...
interface PostProposal {
  ...
  target_performance?: number;   // Target performance metric
