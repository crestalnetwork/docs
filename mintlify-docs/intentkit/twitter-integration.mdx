...
description: 'Guide to integrating Twitter with IntentKit agents.'
---
...
If you have used the docker-compose, it already runs automatically.
```bash
...
Rate limits on the Twitter side can be found [here](https://developer.x.com/en/docs/x-api/rate-limits).
